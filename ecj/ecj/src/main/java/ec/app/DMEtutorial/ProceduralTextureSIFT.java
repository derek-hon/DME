...
public class ProceduralTextureSIFT extends ImageLoad {

    double[] TargetSample;
    SIFTFitness siftFitness;
    String savePath = "";
    double targetSIFT = 0;
    int[][] targetData;
    ...
    public void evaluate(EvolutionState state, Elite ind, int submap, int threadnum) {
        ...
        siftFitness = new SIFTFitness(targetData, ind.getPixels());
        double fitness = siftFitness.getSIFT();
