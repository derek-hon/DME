...
#include "/home/derek/Documents/thesis-ecj/ecj/opencv/../opencv_contrib/modules/bgsegm/include/opencv2/bgsegm.hpp"
...
//
//  native support for java finalize()
//  static void Ptr<cv::bgsegm::BackgroundSubtractorLSBPDesc>::delete( __int64 self )
//
...
JNIEXPORT void JNICALL Java_org_opencv_bgsegm_BackgroundSubtractorLSBPDesc_delete
  (JNIEnv*, jclass, jlong self)
{
    delete (Ptr<cv::bgsegm::BackgroundSubtractorLSBPDesc>*) self;
}
  ...
  (JNIEnv* env, jclass , jlong background_nativeObj, jlong object_nativeObj, jdouble amplitude, jdouble wavelength, jdouble wavespeed, jdouble objspeed)
{
    ...
    try {
        ...
        Mat& background = *((Mat*)background_nativeObj);
        Mat& object = *((Mat*)object_nativeObj);
        Ptr<cv::bgsegm::SyntheticSequenceGenerator> _retval_ = makePtr<cv::bgsegm::SyntheticSequenceGenerator>( background, object, (double)amplitude, (double)wavelength, (double)wavespeed, (double)objspeed );
        return (jlong)(new Ptr<cv::bgsegm::SyntheticSequenceGenerator>(_retval_));
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
        throwJavaException(env, 0, method_name);
