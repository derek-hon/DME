...
#include "/home/derek/Documents/thesis-ecj/ecj/opencv/../opencv_contrib/modules/wechat_qrcode/include/opencv2/wechat_qrcode.hpp"
...
JNIEXPORT void JNICALL Java_org_opencv_wechat_1qrcode_WeChatQRCode_setScaleFactor_10 (JNIEnv*, jclass, jlong, jfloat);

JNIEXPORT void JNICALL Java_org_opencv_wechat_1qrcode_WeChatQRCode_setScaleFactor_10
  (JNIEnv* env, jclass , jlong self, jfloat _scalingFactor)
{
    using namespace cv::wechat_qrcode;
    static const char method_name[] = "wechat_1qrcode::setScaleFactor_10()";
    try {
        LOGD("%s", method_name);
        Ptr<cv::wechat_qrcode::WeChatQRCode>* me = (Ptr<cv::wechat_qrcode::WeChatQRCode>*) self; //TODO: check for NULL
        (*me)->setScaleFactor( (float)_scalingFactor );
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
        throwJavaException(env, 0, method_name);
...
JNIEXPORT jfloat JNICALL Java_org_opencv_wechat_1qrcode_WeChatQRCode_getScaleFactor_10 (JNIEnv*, jclass, jlong);

JNIEXPORT jfloat JNICALL Java_org_opencv_wechat_1qrcode_WeChatQRCode_getScaleFactor_10
  (JNIEnv* env, jclass , jlong self)
{
    using namespace cv::wechat_qrcode;
    static const char method_name[] = "wechat_1qrcode::getScaleFactor_10()";
    try {
        LOGD("%s", method_name);
        Ptr<cv::wechat_qrcode::WeChatQRCode>* me = (Ptr<cv::wechat_qrcode::WeChatQRCode>*) self; //TODO: check for NULL
