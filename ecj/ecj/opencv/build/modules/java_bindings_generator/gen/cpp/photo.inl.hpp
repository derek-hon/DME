...
#include "/home/derek/Documents/thesis-ecj/ecj/opencv/modules/photo/include/opencv2/photo.hpp"
#include "/home/derek/Documents/thesis-ecj/ecj/opencv/modules/photo/include/opencv2/photo/cuda.hpp"
  ...
  (JNIEnv* env, jclass , jlong self)
{
    ...
    try {
        LOGD("%s", method_name);
        Ptr<cv::CalibrateRobertson>* me = (Ptr<cv::CalibrateRobertson>*) self; //TODO: check for NULL
        cv::Mat _retval_ = (*me)->getRadiance();
