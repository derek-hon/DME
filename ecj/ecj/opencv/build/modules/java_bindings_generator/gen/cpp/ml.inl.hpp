...
#include "/home/derek/Documents/thesis-ecj/ecj/opencv/modules/ml/include/opencv2/ml.hpp"
  ...
  (JNIEnv* env, jclass , jlong self)
{
    ...
    try {
        LOGD("%s", method_name);
        Ptr<cv::ml::ANN_MLP>* me = (Ptr<cv::ml::ANN_MLP>*) self; //TODO: check for NULL
        cv::Mat _retval_ = (*me)->getLayerSizes();
  ...
  (JNIEnv* env, jclass , jlong self, jint layerIdx)
{
    ...
    try {
        LOGD("%s", method_name);
        Ptr<cv::ml::ANN_MLP>* me = (Ptr<cv::ml::ANN_MLP>*) self; //TODO: check for NULL
        cv::Mat _retval_ = (*me)->getWeights( (int)layerIdx );
        return (jlong) new cv::Mat(_retval_);
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
  ...
  (JNIEnv* env, jclass , jlong self)
{
    ...
    try {
        LOGD("%s", method_name);
        Ptr<cv::ml::LogisticRegression>* me = (Ptr<cv::ml::LogisticRegression>*) self; //TODO: check for NULL
        cv::Mat _retval_ = (*me)->get_learnt_thetas();
        return (jlong) new cv::Mat(_retval_);
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
  ...
  (JNIEnv* env, jclass , jlong self)
{
    ...
    try {
        LOGD("%s", method_name);
        Ptr<cv::ml::RTrees>* me = (Ptr<cv::ml::RTrees>*) self; //TODO: check for NULL
        cv::Mat _retval_ = (*me)->getVarImportance();
        return (jlong) new cv::Mat(_retval_);
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
...
JNIEXPORT jdouble JNICALL Java_org_opencv_ml_RTrees_getOOBError_10 (JNIEnv*, jclass, jlong);

JNIEXPORT jdouble JNICALL Java_org_opencv_ml_RTrees_getOOBError_10
  (JNIEnv* env, jclass , jlong self)
{
    using namespace cv::ml;
    static const char method_name[] = "ml::getOOBError_10()";
    try {
        LOGD("%s", method_name);
        Ptr<cv::ml::RTrees>* me = (Ptr<cv::ml::RTrees>*) self; //TODO: check for NULL
        return (*me)->getOOBError();
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
        throwJavaException(env, 0, method_name);
  ...
  (JNIEnv* env, jclass , jlong self)
{
    ...
    try {
        LOGD("%s", method_name);
        Ptr<cv::ml::SVM>* me = (Ptr<cv::ml::SVM>*) self; //TODO: check for NULL
        cv::Mat _retval_ = (*me)->getClassWeights();
        return (jlong) new cv::Mat(_retval_);
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
  ...
  (JNIEnv* env, jclass , jlong self)
{
    ...
    try {
        LOGD("%s", method_name);
        Ptr<cv::ml::SVM>* me = (Ptr<cv::ml::SVM>*) self; //TODO: check for NULL
        cv::Mat _retval_ = (*me)->getSupportVectors();
        return (jlong) new cv::Mat(_retval_);
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
  ...
  (JNIEnv* env, jclass , jlong self)
{
    ...
    try {
        LOGD("%s", method_name);
        Ptr<cv::ml::SVM>* me = (Ptr<cv::ml::SVM>*) self; //TODO: check for NULL
        cv::Mat _retval_ = (*me)->getUncompressedSupportVectors();
        return (jlong) new cv::Mat(_retval_);
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
...
JNIEXPORT jboolean JNICALL Java_org_opencv_ml_StatModel_train_10 (JNIEnv*, jclass, jlong, jlong, jint);
...
JNIEXPORT jboolean JNICALL Java_org_opencv_ml_StatModel_train_11 (JNIEnv*, jclass, jlong, jlong);
...
JNIEXPORT jboolean JNICALL Java_org_opencv_ml_StatModel_train_12 (JNIEnv*, jclass, jlong, jlong, jint, jlong);
  ...
  (JNIEnv* env, jclass , jlong self, jint layout, jboolean compressSamples, jboolean compressVars)
{
    ...
    try {
        LOGD("%s", method_name);
        Ptr<cv::ml::TrainData>* me = (Ptr<cv::ml::TrainData>*) self; //TODO: check for NULL
        cv::Mat _retval_ = (*me)->getTrainSamples( (int)layout, (bool)compressSamples, (bool)compressVars );
        return (jlong) new cv::Mat(_retval_);
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
  ...
  (JNIEnv* env, jclass , jlong self, jint layout, jboolean compressSamples)
{
    ...
    try {
        LOGD("%s", method_name);
        Ptr<cv::ml::TrainData>* me = (Ptr<cv::ml::TrainData>*) self; //TODO: check for NULL
        cv::Mat _retval_ = (*me)->getTrainSamples( (int)layout, (bool)compressSamples );
        return (jlong) new cv::Mat(_retval_);
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
  ...
  (JNIEnv* env, jclass , jlong self, jint layout)
{
    ...
    try {
        LOGD("%s", method_name);
        Ptr<cv::ml::TrainData>* me = (Ptr<cv::ml::TrainData>*) self; //TODO: check for NULL
        cv::Mat _retval_ = (*me)->getTrainSamples( (int)layout );
        return (jlong) new cv::Mat(_retval_);
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
  ...
  (JNIEnv* env, jclass , jlong self)
{
    ...
    try {
        LOGD("%s", method_name);
        Ptr<cv::ml::TrainData>* me = (Ptr<cv::ml::TrainData>*) self; //TODO: check for NULL
        cv::Mat _retval_ = (*me)->getTrainSamples();
        return (jlong) new cv::Mat(_retval_);
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
  ...
  (JNIEnv* env, jclass , jlong self)
{
    ...
    try {
        LOGD("%s", method_name);
        Ptr<cv::ml::TrainData>* me = (Ptr<cv::ml::TrainData>*) self; //TODO: check for NULL
        cv::Mat _retval_ = (*me)->getTrainResponses();
        return (jlong) new cv::Mat(_retval_);
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
  ...
  (JNIEnv* env, jclass , jlong self)
{
    ...
    try {
        LOGD("%s", method_name);
        Ptr<cv::ml::TrainData>* me = (Ptr<cv::ml::TrainData>*) self; //TODO: check for NULL
        cv::Mat _retval_ = (*me)->getTrainNormCatResponses();
        return (jlong) new cv::Mat(_retval_);
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
  ...
  (JNIEnv* env, jclass , jlong self)
{
    ...
    try {
        LOGD("%s", method_name);
        Ptr<cv::ml::TrainData>* me = (Ptr<cv::ml::TrainData>*) self; //TODO: check for NULL
        cv::Mat _retval_ = (*me)->getTestResponses();
        return (jlong) new cv::Mat(_retval_);
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
  ...
  (JNIEnv* env, jclass , jlong self)
{
    ...
    try {
        LOGD("%s", method_name);
        Ptr<cv::ml::TrainData>* me = (Ptr<cv::ml::TrainData>*) self; //TODO: check for NULL
        cv::Mat _retval_ = (*me)->getTestNormCatResponses();
        return (jlong) new cv::Mat(_retval_);
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
  ...
  (JNIEnv* env, jclass , jlong self)
{
    ...
    try {
        LOGD("%s", method_name);
        Ptr<cv::ml::TrainData>* me = (Ptr<cv::ml::TrainData>*) self; //TODO: check for NULL
        cv::Mat _retval_ = (*me)->getResponses();
        return (jlong) new cv::Mat(_retval_);
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
  ...
  (JNIEnv* env, jclass , jlong self)
{
    ...
    try {
        LOGD("%s", method_name);
        Ptr<cv::ml::TrainData>* me = (Ptr<cv::ml::TrainData>*) self; //TODO: check for NULL
        cv::Mat _retval_ = (*me)->getNormCatResponses();
        return (jlong) new cv::Mat(_retval_);
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
  ...
  (JNIEnv* env, jclass , jlong self)
{
    ...
    try {
        LOGD("%s", method_name);
        Ptr<cv::ml::TrainData>* me = (Ptr<cv::ml::TrainData>*) self; //TODO: check for NULL
        cv::Mat _retval_ = (*me)->getSampleWeights();
        return (jlong) new cv::Mat(_retval_);
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
  ...
  (JNIEnv* env, jclass , jlong self)
{
    ...
    try {
        LOGD("%s", method_name);
        Ptr<cv::ml::TrainData>* me = (Ptr<cv::ml::TrainData>*) self; //TODO: check for NULL
        cv::Mat _retval_ = (*me)->getTrainSampleWeights();
        return (jlong) new cv::Mat(_retval_);
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
  ...
  (JNIEnv* env, jclass , jlong self)
{
    ...
    try {
        LOGD("%s", method_name);
        Ptr<cv::ml::TrainData>* me = (Ptr<cv::ml::TrainData>*) self; //TODO: check for NULL
        cv::Mat _retval_ = (*me)->getTestSampleWeights();
        return (jlong) new cv::Mat(_retval_);
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
  ...
  (JNIEnv* env, jclass , jlong self)
{
    ...
    try {
        LOGD("%s", method_name);
        Ptr<cv::ml::TrainData>* me = (Ptr<cv::ml::TrainData>*) self; //TODO: check for NULL
        cv::Mat _retval_ = (*me)->getVarSymbolFlags();
        return (jlong) new cv::Mat(_retval_);
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
  ...
  (JNIEnv* env, jclass , jlong self)
{
    ...
    try {
        LOGD("%s", method_name);
        Ptr<cv::ml::TrainData>* me = (Ptr<cv::ml::TrainData>*) self; //TODO: check for NULL
        cv::Mat _retval_ = (*me)->getTrainSampleIdx();
        return (jlong) new cv::Mat(_retval_);
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
  ...
  (JNIEnv* env, jclass , jlong self)
{
    ...
    try {
        LOGD("%s", method_name);
        Ptr<cv::ml::TrainData>* me = (Ptr<cv::ml::TrainData>*) self; //TODO: check for NULL
        cv::Mat _retval_ = (*me)->getTestSampleIdx();
        return (jlong) new cv::Mat(_retval_);
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
  ...
  (JNIEnv* env, jclass , jlong self)
{
    ...
    try {
        LOGD("%s", method_name);
        Ptr<cv::ml::TrainData>* me = (Ptr<cv::ml::TrainData>*) self; //TODO: check for NULL
        cv::Mat _retval_ = (*me)->getDefaultSubstValues();
        return (jlong) new cv::Mat(_retval_);
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
  ...
  (JNIEnv* env, jclass , jlong self)
{
    ...
    try {
        LOGD("%s", method_name);
        Ptr<cv::ml::TrainData>* me = (Ptr<cv::ml::TrainData>*) self; //TODO: check for NULL
        cv::Mat _retval_ = (*me)->getClassLabels();
        return (jlong) new cv::Mat(_retval_);
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
  ...
  (JNIEnv* env, jclass , jlong self)
{
    ...
    try {
        LOGD("%s", method_name);
        Ptr<cv::ml::TrainData>* me = (Ptr<cv::ml::TrainData>*) self; //TODO: check for NULL
        cv::Mat _retval_ = (*me)->getTestSamples();
        return (jlong) new cv::Mat(_retval_);
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
  ...
  (JNIEnv* env, jclass , jlong vec_nativeObj, jlong idx_nativeObj)
{
    ...
    try {
        ...
        cv::Mat _retval_ = cv::ml::TrainData::getSubVector( vec, idx );
        return (jlong) new cv::Mat(_retval_);
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
  ...
  (JNIEnv* env, jclass , jlong matrix_nativeObj, jlong idx_nativeObj, jint layout)
{
    ...
    try {
        ...
        Mat& idx = *((Mat*)idx_nativeObj);
        cv::Mat _retval_ = cv::ml::TrainData::getSubMatrix( matrix, idx, (int)layout );
        return (jlong) new cv::Mat(_retval_);
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
