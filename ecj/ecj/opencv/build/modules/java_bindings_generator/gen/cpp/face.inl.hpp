...
#include "/home/derek/Documents/thesis-ecj/ecj/opencv/../opencv_contrib/modules/face/include/opencv2/face.hpp"
#include "/home/derek/Documents/thesis-ecj/ecj/opencv/../opencv_contrib/modules/face/include/opencv2/face/facemarkAAM.hpp"
#include "/home/derek/Documents/thesis-ecj/ecj/opencv/../opencv_contrib/modules/face/include/opencv2/face/bif.hpp"
#include "/home/derek/Documents/thesis-ecj/ecj/opencv/../opencv_contrib/modules/face/include/opencv2/face/facerec.hpp"
#include "/home/derek/Documents/thesis-ecj/ecj/opencv/../opencv_contrib/modules/face/include/opencv2/face/face_alignment.hpp"
#include "/home/derek/Documents/thesis-ecj/ecj/opencv/../opencv_contrib/modules/face/include/opencv2/face/facemark.hpp"
#include "/home/derek/Documents/thesis-ecj/ecj/opencv/../opencv_contrib/modules/face/include/opencv2/face/mace.hpp"
#include "/home/derek/Documents/thesis-ecj/ecj/opencv/../opencv_contrib/modules/face/include/opencv2/face/predict_collector.hpp"
#include "/home/derek/Documents/thesis-ecj/ecj/opencv/../opencv_contrib/modules/face/include/opencv2/face/facemark_train.hpp"
#include "/home/derek/Documents/thesis-ecj/ecj/opencv/../opencv_contrib/modules/face/include/opencv2/face/facemarkLBF.hpp"
  ...
  (JNIEnv* env, jclass , jlong self)
{
    ...
    try {
        LOGD("%s", method_name);
        Ptr<cv::face::BasicFaceRecognizer>* me = (Ptr<cv::face::BasicFaceRecognizer>*) self; //TODO: check for NULL
        cv::Mat _retval_ = (*me)->getEigenValues();
        return (jlong) new cv::Mat(_retval_);
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
  ...
  (JNIEnv* env, jclass , jlong self)
{
    ...
    try {
        LOGD("%s", method_name);
        Ptr<cv::face::BasicFaceRecognizer>* me = (Ptr<cv::face::BasicFaceRecognizer>*) self; //TODO: check for NULL
        cv::Mat _retval_ = (*me)->getEigenVectors();
        return (jlong) new cv::Mat(_retval_);
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
...
//
//  native support for java finalize()
//  static void Ptr<cv::face::PredictCollector>::delete( __int64 self )
//
...
JNIEXPORT void JNICALL Java_org_opencv_face_PredictCollector_delete
  (JNIEnv*, jclass, jlong self)
{
    delete (Ptr<cv::face::PredictCollector>*) self;
}
