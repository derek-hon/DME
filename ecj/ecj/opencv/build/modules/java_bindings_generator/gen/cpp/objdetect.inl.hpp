...
#include "/home/derek/Documents/thesis-ecj/ecj/opencv/modules/objdetect/include/opencv2/objdetect.hpp"
#include "/home/derek/Documents/thesis-ecj/ecj/opencv/modules/objdetect/include/opencv2/objdetect/aruco_detector.hpp"
#include "/home/derek/Documents/thesis-ecj/ecj/opencv/modules/objdetect/include/opencv2/objdetect/charuco_detector.hpp"
#include "/home/derek/Documents/thesis-ecj/ecj/opencv/modules/objdetect/include/opencv2/objdetect/aruco_board.hpp"
#include "/home/derek/Documents/thesis-ecj/ecj/opencv/modules/objdetect/include/opencv2/objdetect/aruco_dictionary.hpp"
#include "/home/derek/Documents/thesis-ecj/ecj/opencv/modules/objdetect/include/opencv2/objdetect/detection_based_tracker.hpp"
#include "/home/derek/Documents/thesis-ecj/ecj/opencv/modules/objdetect/include/opencv2/objdetect/face.hpp"
  ...
  (JNIEnv* env, jclass )
{
    ...
    try {
        LOGD("%s", method_name);
        Ptr<cv::QRCodeDetector> _retval_ = makePtr<cv::QRCodeDetector>();
        return (jlong)(new Ptr<cv::QRCodeDetector>(_retval_));
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
        throwJavaException(env, 0, method_name);
  ...
  (JNIEnv* env, jclass , jlong self, jdouble epsX)
{
    ...
    try {
        LOGD("%s", method_name);
        Ptr<cv::QRCodeDetector>* me = (Ptr<cv::QRCodeDetector>*) self; //TODO: check for NULL
...
JNIEXPORT void JNICALL Java_org_opencv_objdetect_QRCodeDetector_setUseAlignmentMarkers_10 (JNIEnv*, jclass, jlong, jboolean);

JNIEXPORT void JNICALL Java_org_opencv_objdetect_QRCodeDetector_setUseAlignmentMarkers_10
  (JNIEnv* env, jclass , jlong self, jboolean useAlignmentMarkers)
{
    ...
    try {
        LOGD("%s", method_name);
        Ptr<cv::QRCodeDetector>* me = (Ptr<cv::QRCodeDetector>*) self; //TODO: check for NULL
        (*me)->setUseAlignmentMarkers( (bool)useAlignmentMarkers );
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
        throwJavaException(env, 0, method_name);
...
//
//  native support for java finalize()
//  static void Ptr<cv::QRCodeDetector>::delete( __int64 self )
//
...
JNIEXPORT void JNICALL Java_org_opencv_objdetect_QRCodeDetector_delete
  (JNIEnv*, jclass, jlong self)
{
    delete (Ptr<cv::QRCodeDetector>*) self;
}
...
//
//  void cv::aruco::CharucoDetector::detectDiamonds(Mat image, vector_Mat& diamondCorners, Mat& diamondIds, vector_Mat& markerCorners = vector_Mat(), vector_Mat& markerIds = vector_Mat())
//
...
JNIEXPORT void JNICALL Java_org_opencv_objdetect_CharucoDetector_detectDiamonds_10
  (JNIEnv* env, jclass , jlong self, jlong image_nativeObj, jlong diamondCorners_mat_nativeObj, jlong diamondIds_nativeObj, jlong markerCorners_mat_nativeObj, jlong markerIds_mat_nativeObj)
{
    using namespace cv::aruco;
    ...
    try {
        ...
        Mat& markerCorners_mat = *((Mat*)markerCorners_mat_nativeObj);
        Mat_to_vector_Mat( markerCorners_mat, markerCorners );
        std::vector<Mat> markerIds;
        Mat& markerIds_mat = *((Mat*)markerIds_mat_nativeObj);
        Mat_to_vector_Mat( markerIds_mat, markerIds );
        Ptr<cv::aruco::CharucoDetector>* me = (Ptr<cv::aruco::CharucoDetector>*) self; //TODO: check for NULL
        Mat& image = *((Mat*)image_nativeObj);
        Mat& diamondIds = *((Mat*)diamondIds_nativeObj);
        ...
        vector_Mat_to_Mat( markerCorners, markerCorners_mat );
        vector_Mat_to_Mat( markerIds, markerIds_mat );
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
        throwJavaException(env, 0, method_name);
